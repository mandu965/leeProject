		...
		<div class="LEE_LEFT">
			<div id="left_content">
			   <ul id="subMenuList" class="subMenuList">
			    <li><a href="<c:url value="/techmng/tech01.do"/>">tech01</a></li>
			    <li><a href="<c:url value="/techmng/tech02.do"/>">tech02</a></li>
			    <li><a href="<c:url value="/techmng/html5Tag.do"/>">html5Tag</a></li>
			    <li><a href="<c:url value="/techmng/mobileImg.do"/>">mobileImg</a></li> 
			   </ul>
