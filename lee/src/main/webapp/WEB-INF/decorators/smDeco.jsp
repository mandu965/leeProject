		...
		<div class="LEE_LEFT">
			<div id="left_content">
			     <ul id="subMenuList" class="subMenuList">
			     	<li><a href="<c:url value="/sm/usrmng/usrmngList.do"/>">사용자관리</a></li>
			     	<li><a href="<c:url value="/sm/ordermng/ordermngList.do"/>">주문상품관리</a></li>
			        <li><a href="<c:url value="/sm/prdtmng/prdtmngList.do"/>">상품관리</a></li>
			        <li><a href="<c:url value="/sm/catemng/catemngList.do"/>">상품 카테고리 관리</a></li>
	              </ul>
              </div>
		</div>
		<!-- left : E -->
