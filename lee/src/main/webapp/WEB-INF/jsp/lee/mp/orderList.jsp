...
<c:set var="CTX_PATH" value="/mypage/orderList/" scope="request"/>
								...
								<c:when test="${not empty articleList}">
									<c:forEach items="${articleList}" var="articleList" varStatus="idx">
										...
										<tr class="${idx.count % 2 == 1 ? 'trOdd' : 'trEven'}">
											...
											<td style="width:10px;overflow:hidden;text-overflow;ellipsis;" ><c:out value="${articleList.prdt_count}"/></td>
