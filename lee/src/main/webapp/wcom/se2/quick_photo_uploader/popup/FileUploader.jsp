...
<%@ page import="lee.LeeConstants" %>
<%
String filename = "";
String fileExt = "";
String realFolder = LeeConstants.getBbsSaveDir();	//웹 어플리케이션의 절대경로
//파일이 업로드되는 폴더를 지정한다
...
try{
	...
	while(files.hasMoreElements()){
        ...
        File oldfile = new File(LeeConstants.getBbsSaveDir() + "/" + filename);
        File newfile = new File(LeeConstants.getBbsSaveDir() + "/" + realfilename);
		...
		url += "&sFileURL=" + LeeConstants.getBbsSaveUrl() + "/" + realfilename;
	}
